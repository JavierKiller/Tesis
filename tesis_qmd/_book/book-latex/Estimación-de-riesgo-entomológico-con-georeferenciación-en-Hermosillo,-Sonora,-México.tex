...
favorecen su transmisión {[}(\textbf{gobmx2023?});{]}. Entre ellas, el
...
unidad de muestreo básica es la casa o localidad
{[}(\textbf{gobmx2023?});{]}. Al muestrear, el objetivo es observar
sistemáticamente contenedores de almacenamiento de agua. Los
contenedores se examinan para detectar la presencia de larvas y pupas de
mosquitos.
...
La base de datos de EE es un archivo .txt de la Plataforma Vigilancia
Entomológica y Control Integral del Vector cuando esta base de datos es
llenada no tiene celdas vacias en Tiene 121 variables
